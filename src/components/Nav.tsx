...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] h-16 border-b border-[rgba(255,179,212,0.25)] backdrop-blur-[18px] -webkit-backdrop-blur-[18px] bg-[rgba(255,245,249,0.72)]">
