...
const LINKS: ContactLink[] = [
  ...
  { href: 'https://github.com/DuruGncy', label: 'GitHub', icon: '⌥', external: true },
  { href: 'https://linkedin.com/in/durugencay', label: 'LinkedIn', icon: '⬡', external: true },
  { href: 'https://medium.com/@durugencayy', label: 'Medium', icon: '◈', external: true },
];
  ...
  return (
    ...
    >
      ...
      <p className="reveal text-[0.8rem] opacity-65 max-w-[420px] mx-auto leading-[1.8] mb-10">
        I'm open to internships, graduate roles, and collaborations starting 2026. Reach out — I read every message.
      </p>
